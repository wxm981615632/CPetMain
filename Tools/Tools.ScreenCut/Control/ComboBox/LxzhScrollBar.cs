    ...
    public partial class LxzhScrollBar : LxzhRoundControl {
        ...
        private void drawUpArrow(Graphics g) {
            ...
            if (arrowState > 0) {
                ...
                g.DrawImage(global::Tools.ScreenCut.Properties.Resources.arrowlist.Clone(new Rectangle(33, 0, 11, 11), PixelFormat.Format32bppPArgb), rect);
                arrowState--;
                if (arrowState > 0) {
                    ...
                    arrowState--;
                    if (arrowState > 0) {
                        g.DrawImage(global::Tools.ScreenCut.Properties.Resources.arrowlist.Clone(new Rectangle(22, 0, 11, 11), PixelFormat.Format32bppPArgb), rect);
                    }
                }
            }
        }
        ...
        private void drawDownArrow(Graphics g) {
            ...
            if (arrowState > 0) {
                ...
                g.DrawImage(global::Tools.ScreenCut.Properties.Resources.arrowlist.Clone(new Rectangle(11, 0, 11, 11), PixelFormat.Format32bppPArgb), rect);
                arrowState--;
                if (arrowState > 0) {
                    ...
                    arrowState--;
                    if (arrowState > 0) {
                        g.DrawImage(global::Tools.ScreenCut.Properties.Resources.arrowlist.Clone(new Rectangle(0, 0, 11, 11), PixelFormat.Format32bppPArgb), rect);
                    }
                    path.Dispose();
                }
            }
