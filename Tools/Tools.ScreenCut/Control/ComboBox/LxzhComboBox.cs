...
namespace Tools.ScreenCut
{
    ...
    public partial class LxzhComboBox : PictureBox {
        ...
        protected override void OnPaint(PaintEventArgs pe) {
            ...
            if (isPopup) {
                g.DrawImage(global::Tools.ScreenCut.Properties.Resources.arrowlist.Clone(new Rectangle(33, 0, 11, 11), System.Drawing.Imaging.PixelFormat.Format32bppPArgb), new Rectangle(this.Width - 18, 6, 11, 11));
            } else {
                g.DrawImage(global::Tools.ScreenCut.Properties.Resources.arrowlist.Clone(new Rectangle(11, 0, 11, 11), System.Drawing.Imaging.PixelFormat.Format32bppPArgb), new Rectangle(this.Width - 18, 6, 11, 11));
            }
