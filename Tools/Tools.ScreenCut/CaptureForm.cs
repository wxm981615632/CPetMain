...
namespace Tools.ScreenCut
{
    public partial class CaptureForm : Form
    {
        ...
        private void CaptureForm_Load(object sender, EventArgs e) {
            ...
            crossCursor = new Cursor(global::Tools.ScreenCut.Properties.Resources.cross.GetHicon());
            isAlive = true;
        }
        ...
        private Bitmap GetScreen(bool bCaptureCursor, bool bFromClipBoard) {
            ...
            //bmp = new Bitmap(Screen.AllScreens[ScreenIndex].Bounds.Width, Screen.AllScreens[ScreenIndex].Bounds.Height);
        ...
        private void imageProcessBox_Load(object sender, EventArgs e)
        {
